  ...
  return (
    <>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
          ...
          <BentoCard colSpan="md:col-span-2" rowSpan="md:row-span-2" delay={0}>
            <div className="flex flex-col justify-between h-full">
              <div className="space-y-4">
                <img
                  className="w-48 h-[250px] object-cover rounded-3xl"
        ...
        <div className="mt-16 w-full">
          <div className="mb-6 px-4 md:px-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-neutral-900 dark:text-white">GitHub Contributions</h2>
            </div>
            <p className="text-neutral-600 dark:text-neutral-500 text-sm mt-1 pb-4">My real-time contribution graph from GitHub.</p>
          </div>

          <div className="flex justify-center mb-12 sm:mx-6 md:mx-12 lg:mx-20 bg-white/40 dark:bg-neutral-900/40 rounded-3xl border border-neutral-200 dark:border-white/5 p-6 overflow-hidden">
            <div className="w-full overflow-x-auto flex justify-center text-neutral-900 dark:text-gray-200">
              <div className="min-w-max">
                <GitHubCalendar 
                  username="ajay-yadav143" 
                  colorScheme="dark"
                />
              </div>
            </div>
        ...
        {/* Contact Form */}
        <div className="mt-20 w-full max-w-3xl mx-auto px-4 sm:px-6 md:px-0">
          <ContactForm />
        </div>
